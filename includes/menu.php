<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-icon rotate-n-15">
         <!--  <img src="img/avatar.png" width="50px" height="40px">  colocar imagen o logo -->
        </div>
        <div class="sidebar-brand-text mx-3">MANTIZ <sup>🅜</sup></div>
      </a>
      ...
      <li class="nav-item ">
      <a class="nav-link collapsed" href="inventario_general.php" data-toggle="collapse" data-target="#collapseThree"  aria-controls="collapseThree">
          <i class="fas fa-fw fa-folder"></i>
