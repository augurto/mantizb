...
<?php 
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><b>Obra  </b> <?php echo$_GET['nom']?></h1>
               <?php if($_GET['estado']=='activo'){ ?>
                ...
                <a href="#" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"   data-toggle="modal" data-target="#nuevoMat"><i class="fas fa-user fa-sm text-white-50"></i> materiales</a>
          <?php } ?>
          </div>
 ...
 <?php include('modal/logout.php'); ?>
  ...
  <script src="vendor/jquery/jquery.min.js"></script>
    ...
    <script src="js/b_materiales.js"></script>
